...
manet_decoder_params = {
    ...
    "resnet50": {
        ...
        "reduced_channels": [64, 32, 16, 4],
        "outputs": [2048, 256, 128, 64, 32, 16],
    },
    "resnet101": {
        "inputs": [
            2048,
    ...
    "efficientnetb0": {
        ...
        "reduced_channels": [7, 2, 1, 2],
        "outputs": [320, 256, 128, 64, 32, 16],
    },
    "efficientnetb1": {
        "inputs": [
            320,
    ...
    "efficientnetb2": {
        ...
        "reduced_channels": [7, 3, 1, 2],
        "outputs": [352, 256, 128, 64, 32, 16],
    },
    "efficientnetb3": {
        "inputs": [
            384,
        ...
        "reduced_channels": [8, 3, 2, 2],
        "outputs": [384, 256, 128, 64, 32, 16],
    },
    "efficientnetb4": {
        "inputs": [
            448,
        ...
        "reduced_channels": [10, 3, 2, 2],
        "outputs": [448, 256, 128, 64, 32, 16],
    },
    "efficientnetb5": {
        "inputs": [
            512,
    ...
    "efficientnetb6": {
        ...
        "reduced_channels": [12, 4, 2, 3],
        "outputs": [576, 256, 128, 64, 32, 16],
    },
    "efficientnetb7": {
        "inputs": [
            640,
        ...
        "reduced_channels": [14, 5, 3, 4],
        "outputs": [640, 256, 128, 64, 32, 16],
    },
}
